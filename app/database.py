...
class DatabaseManager:
    ...
    async def get_user_briefs(self, user_id: str, limit: int = 10) -> List[FinalBrief]:
        ...
        async with self.get_session() as session:
            ...
            return [FinalBrief.parse_obj(b.brief_data) for b in briefs]
    ...
    async def get_user_context(self, user_id: str) -> Optional[UserContext]:
        ...
        async with self.get_session() as session:
            ...
            if db_context:
                return UserContext.parse_obj(db_context.context_data)
        return None
    ...
    async def update_user_context_with_brief(self, user_id: str, topic: str, summary: str):
        ...
        async with self.get_session() as session:
            ...
            if db_context:
                user_context = UserContext.parse_obj(db_context.context_data)
                ...
                db_context.context_data = user_context.dict()
